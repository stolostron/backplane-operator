...
# This is a copy of version2.py from the openshift/hive repository before it was
# removed in commit f1bc37a1b (Feb 2025). Hive converted version2.py to version2.sh
# to remove Python dependencies from container builds, but forgot to update
# bundle-gen.py which still imports this module.
#
# We maintain this local copy to ensure bundle-gen.py works when we generate Hive
# bundles via gen-hive-bundle.sh. This file is copied into the cloned Hive repo
# before running bundle-gen.py.
#
# Source: https://github.com/openshift/hive/blob/f1bc37a1b^/hack/version2.py
