...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclusters/status;awsfargateprofiles/status;rosaclusters/status;rosamachinepools/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclusters;awsfargateprofiles;awsmachinepools;awsmanagedclusters;awsmanagedmachinepools;rosaclusters;rosamachinepools,verbs=delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmachines,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=ipam.metal3.io,resources=ipaddresses;ipclaims;ippools,verbs=create;delete;get;list;patch;update;watch
