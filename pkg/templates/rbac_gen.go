...
//+kubebuilder:rbac:groups=apiextensions.k8s.io,resources=customresourcedefinitions;customresourcedefinitions/status,verbs=patch;update
//+kubebuilder:rbac:groups=apiextensions.k8s.io,resources=customresourcedefinitions;customresourcedefinitions/status,verbs=patch;update
//+kubebuilder:rbac:groups=apimanagement.azure.com,resources=apidiagnostics/finalizers;apidiagnostics/status;apipolicies/finalizers;apipolicies/status;apis/finalizers;apis/status;apiversionsets/finalizers;apiversionsets/status;authorizationproviders/finalizers;authorizationproviders/status;authorizationprovidersauthorizations/finalizers;authorizationprovidersauthorizations/status;authorizationprovidersauthorizationsaccesspolicies/finalizers;authorizationprovidersauthorizationsaccesspolicies/status;backends/finalizers;backends/status;certificates/finalizers;certificates/status;diagnostics/finalizers;diagnostics/status;groups/finalizers;groups/status;loggers/finalizers;loggers/status;namedvalues/finalizers;namedvalues/status;policies/finalizers;policies/status;policyfragments/finalizers;policyfragments/status;productapis/finalizers;productapis/status;productgroups/finalizers;productgroups/status;productpolicies/finalizers;productpolicies/status;products/finalizers;products/status;servicegatewayapis/finalizers;servicegatewayapis/status;servicegatewaycertificateauthorities/finalizers;servicegatewaycertificateauthorities/status;servicegatewayhostnameconfigurations/finalizers;servicegatewayhostnameconfigurations/status;servicegateways/finalizers;servicegateways/status;services/finalizers;services/status;subscriptions/finalizers;subscriptions/status;users/finalizers;users/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=apimanagement.azure.com,resources=apidiagnostics/finalizers;apidiagnostics/status;apipolicies/finalizers;apipolicies/status;apis/finalizers;apis/status;apiversionsets/finalizers;apiversionsets/status;authorizationproviders/finalizers;authorizationproviders/status;authorizationprovidersauthorizations/finalizers;authorizationprovidersauthorizations/status;authorizationprovidersauthorizationsaccesspolicies/finalizers;authorizationprovidersauthorizationsaccesspolicies/status;backends/finalizers;backends/status;certificates/finalizers;certificates/status;diagnostics/finalizers;diagnostics/status;groups/finalizers;groups/status;loggers/finalizers;loggers/status;namedvalues/finalizers;namedvalues/status;policies/finalizers;policies/status;policyfragments/finalizers;policyfragments/status;productapis/finalizers;productapis/status;productgroups/finalizers;productgroups/status;productpolicies/finalizers;productpolicies/status;products/finalizers;products/status;servicegatewayapis/finalizers;servicegatewayapis/status;servicegatewaycertificateauthorities/finalizers;servicegatewaycertificateauthorities/status;servicegatewayhostnameconfigurations/finalizers;servicegatewayhostnameconfigurations/status;servicegateways/finalizers;servicegateways/status;services/finalizers;services/status;subscriptions/finalizers;subscriptions/status;users/finalizers;users/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=apimanagement.azure.com,resources=apidiagnostics;apipolicies;apis;apiversionsets;authorizationproviders;authorizationprovidersauthorizations;authorizationprovidersauthorizationsaccesspolicies;backends;certificates;diagnostics;groups;loggers;namedvalues;policies;policyfragments;productapis;productgroups;productpolicies;products;servicegatewayapis;servicegatewaycertificateauthorities;servicegatewayhostnameconfigurations;servicegateways;services;subscriptions;users,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=apimanagement.azure.com,resources=apidiagnostics;apipolicies;apis;apiversionsets;authorizationproviders;authorizationprovidersauthorizations;authorizationprovidersauthorizationsaccesspolicies;backends;certificates;diagnostics;groups;loggers;namedvalues;policies;policyfragments;productapis;productgroups;productpolicies;products;servicegatewayapis;servicegatewaycertificateauthorities;servicegatewayhostnameconfigurations;servicegateways;services;subscriptions;users,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=bootstrap.cluster.x-k8s.io;controlplane.cluster.x-k8s.io;infrastructure.cluster.x-k8s.io,resources=*,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cache.azure.com,resources=redis/finalizers;redis/status;redisaccesspolicies/finalizers;redisaccesspolicies/status;redisaccesspolicyassignments/finalizers;redisaccesspolicyassignments/status;redisenterprisedatabaseaccesspolicyassignments/finalizers;redisenterprisedatabaseaccesspolicyassignments/status;redisenterprisedatabases/finalizers;redisenterprisedatabases/status;redisenterprises/finalizers;redisenterprises/status;redisfirewallrules/finalizers;redisfirewallrules/status;redislinkedservers/finalizers;redislinkedservers/status;redispatchschedules/finalizers;redispatchschedules/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cache.azure.com,resources=redis/finalizers;redis/status;redisaccesspolicies/finalizers;redisaccesspolicies/status;redisaccesspolicyassignments/finalizers;redisaccesspolicyassignments/status;redisenterprisedatabaseaccesspolicyassignments/finalizers;redisenterprisedatabaseaccesspolicyassignments/status;redisenterprisedatabases/finalizers;redisenterprisedatabases/status;redisenterprises/finalizers;redisenterprises/status;redisfirewallrules/finalizers;redisfirewallrules/status;redislinkedservers/finalizers;redislinkedservers/status;redispatchschedules/finalizers;redispatchschedules/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cache.azure.com,resources=redis;redisaccesspolicies;redisaccesspolicyassignments;redisenterprisedatabaseaccesspolicyassignments;redisenterprisedatabases;redisenterprises;redisfirewallrules;redislinkedservers;redispatchschedules,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cache.azure.com,resources=redis;redisaccesspolicies;redisaccesspolicyassignments;redisenterprisedatabaseaccesspolicyassignments;redisenterprisedatabases;redisenterprises;redisfirewallrules;redislinkedservers;redispatchschedules,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=cluster.open-cluster-management.io,resources=managedclusters,verbs=get
...
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts/finalizers;accounts/status;deployments/finalizers;deployments/status;projects/finalizers;projects/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts/finalizers;accounts/status;deployments/finalizers;deployments/status;projects/finalizers;projects/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts;deployments;projects,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts;deployments;projects,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=communication.azure.com,resources=communicationservices/finalizers;communicationservices/status;domains/finalizers;domains/status;emailservices/finalizers;emailservices/status;senderusernames/finalizers;senderusernames/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=communication.azure.com,resources=communicationservices/finalizers;communicationservices/status;domains/finalizers;domains/status;emailservices/finalizers;emailservices/status;senderusernames/finalizers;senderusernames/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=communication.azure.com,resources=communicationservices;domains;emailservices;senderusernames,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=communication.azure.com,resources=communicationservices;domains;emailservices;senderusernames,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=containerinstance.azure.com,resources=containergroups/finalizers;containergroups/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=containerregistry.azure.com,resources=registries/finalizers;registries/status;registrycacherules/finalizers;registrycacherules/status;registryreplications/finalizers;registryreplications/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=containerregistry.azure.com,resources=registries/finalizers;registries/status;registrycacherules/finalizers;registrycacherules/status;registryreplications/finalizers;registryreplications/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=containerregistry.azure.com,resources=registries;registrycacherules;registryreplications,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=containerregistry.azure.com,resources=registries;registrycacherules;registryreplications,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=databasewatcher.azure.com,resources=sharedprivatelinks/finalizers;sharedprivatelinks/status;targets/finalizers;targets/status;watchers/finalizers;watchers/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=databasewatcher.azure.com,resources=sharedprivatelinks/finalizers;sharedprivatelinks/status;targets/finalizers;targets/status;watchers/finalizers;watchers/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=databasewatcher.azure.com,resources=sharedprivatelinks;targets;watchers,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=databasewatcher.azure.com,resources=sharedprivatelinks;targets;watchers,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=azuremachinetemplates/status,verbs=get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=azuremanagedcontrolplanes;azureasomanagedcontrolplanes,verbs=get;list;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=azuremanagedcontrolplanes;azureasomanagedcontrolplanes,verbs=get;list;watch
...
//+kubebuilder:rbac:groups=kubernetesconfiguration.azure.com,resources=extensions;fluxconfigurations,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusterprincipalassignments/finalizers;clusterprincipalassignments/status;clusters/finalizers;clusters/status;databases/finalizers;databases/status;dataconnections/finalizers;dataconnections/status;principalassignments/finalizers;principalassignments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusterprincipalassignments/finalizers;clusterprincipalassignments/status;clusters/finalizers;clusters/status;databases/finalizers;databases/status;dataconnections/finalizers;dataconnections/status;principalassignments/finalizers;principalassignments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusterprincipalassignments;clusters;databases;dataconnections;principalassignments,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusterprincipalassignments;clusters;databases;dataconnections;principalassignments,verbs=create;delete;get;list;patch;update;watch
