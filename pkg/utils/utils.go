...
func GetTestImages() []string {
	return []string{"registration_operator", "openshift_hive", "multicloud_manager",
		...
		"cluster_api_provider_azure", "cluster_api_provider_kubevirt", "kube_rbac_proxy_mce", "cluster_proxy_addon", "cluster_proxy", "cluster_image_set_controller", "cluster_relocation", "image_based_install_operator"}
}
