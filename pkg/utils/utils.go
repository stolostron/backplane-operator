...
func GetTestImages() []string {
	return []string{
		...
		"ASSISTED_SERVICE_9", "ASSISTED_IMAGE_SERVICE", "POSTGRESQL_13", "ASSISTED_INSTALLER_AGENT",
		...
		"CLUSTER_API_PROVIDER_AZURE_RHEL9", "AZURE_SERVICE_OPERATOR_RHEL9", "registration_operator",
		...
		"cluster_api_provider_azure_rhel9", "azure_service_operator_rhel9"}
}
