...
const (
	// DefaultLocalClusterName name of the hub cluster managedcluster resource
	DefaultLocalClusterName = "local-cluster"
...
func NewLocalNamespace(name string) *corev1.Namespace {
